...
static void PrintItemDescriptionOnMessageWindow(s32 itemIndex)
{
    ...
    BagPrintTextOnWindow(1, FONT_NORMAL, description, RTL_ANCHOR_WINDOW(1), 3, 2, 0, 0, 0);
}
...
static void BeginMovingItemInPocket(u8 taskId, s16 itemIndex)
{
    ...
    FillWindowPixelBuffer(1, PIXEL_FILL(0));
    BagPrintTextOnWindow(1, FONT_NORMAL, gStringVar4, RTL_ANCHOR_WINDOW(1), 3, 2, 0, 0, 0);
...
static void InitQuantityToTossOrDeposit(u16 cursorPos, const u8 *str)
{
    ...
    BagPrintTextOnWindow(r5, FONT_NORMAL, gStringVar4, GetWindowAttribute(r5, WINDOW_WIDTH) * 8 - 8, 2, 1, 0, 0, 1);
    r4 = ShowBagWindow(0, 0);
    ConvertIntToDecimalStringN(gStringVar1, 1, STR_CONV_MODE_LEADING_ZEROS, 3);
    StringExpandPlaceholders(gStringVar4, gText_TimesStrVar1);
    BagPrintTextOnWindow(r4, FONT_SMALL, gStringVar4, GetWindowAttribute(r4, WINDOW_WIDTH) * 8 - 8, 10, 1, 0, 0, 1);
...
static void UpdateQuantityToTossOrDeposit(s16 value, u8 ndigits)
{
    ...
    StringExpandPlaceholders(gStringVar4, gText_TimesStrVar1);
    BagPrintTextOnWindow(r6, FONT_SMALL, gStringVar4, GetWindowAttribute(r6, WINDOW_WIDTH) * 8 - 8, 10, 1, 0, 0, 1);
}
...
static void OpenContextMenu(u8 taskId)
{
    ...
    BagPrintTextOnWindow(r4, FONT_NORMAL, gStringVar4, 100, 2, 1, 0, 0, 1);
}
...
static void Task_ConfirmTossItems(u8 taskId)
{
    ...
    BagPrintTextOnWindow(ShowBagWindow(6, 1), FONT_NORMAL, gStringVar4, RTL_ANCHOR_WINDOW(ShowBagWindow(6, 1)), 2, 1, 0, 0, 1);
...
static void Task_TossItem_Yes(u8 taskId)
{
    ...
    BagPrintTextOnWindow(ShowBagWindow(6, 3), FONT_NORMAL, gStringVar4, RTL_ANCHOR_WINDOW(ShowBagWindow(6, 3)), 2, 1, 0, 0, 1);
...
static void Task_InitSaleQuantitySelectInterface(u8 taskId)
{
    ...
    StringExpandPlaceholders(gStringVar4, gText_TimesStrVar1);
    BagPrintTextOnWindow(r4, FONT_SMALL, gStringVar4, GetWindowAttribute(r4, WINDOW_WIDTH) * 8 - 8, 10, 1, 0, 0xFF, 1);
