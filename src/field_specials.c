...
void DrawElevatorCurrentFloorWindow(void)
{
    ...
    AddTextPrinterParameterized(sElevatorCurrentFloorWindowId, FONT_NORMAL, gText_NowOn, RTL_ANCHOR_WINDOW(sElevatorCurrentFloorWindowId), 2, 0xFF, NULL);
    floorname = sFloorNamePointers[gSpecialVar_0x8005];
    strwidth = GetStringWidth(FONT_NORMAL, floorname, 0);
    AddTextPrinterParameterized(sElevatorCurrentFloorWindowId, FONT_NORMAL, floorname, RTL_ANCHOR_WINDOW(sElevatorCurrentFloorWindowId), 16, 0xFF, NULL);
