...
static void Task_DrawClearSaveDataScreen(u8 taskId)
{
    ...
    case 4:
        ...
        AddTextPrinterParameterized4(1, FONT_NORMAL, RTL_ANCHOR_WINDOW(1), 3, 1, 1, sTextColor, 0, gText_ClearAllSaveData);
...
static void Task_HandleYesNoMenu(u8 taskId)
{
    ...
    if ((*r5)->unk0 == 0)
    {
        ...
        case 0:
            ...
            AddTextPrinterParameterized4(1, FONT_NORMAL, RTL_ANCHOR_WINDOW(1), 3, 1, 1, sTextColor, 0, gText_ClearingData);
