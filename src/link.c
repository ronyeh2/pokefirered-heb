...
static void ErrorMsg_MoveCloserToPartner(void)
{
    ...
    AddTextPrinterParameterized3(0, FONT_NORMAL_COPY_2, RTL_ANCHOR_WINDOW(0) - 2, 5, sLinkErrorTextColor, 0, gText_CommErrorEllipsis);
    AddTextPrinterParameterized3(2, FONT_NORMAL_COPY_2, RTL_ANCHOR_WINDOW(2) - 2, 2, sLinkErrorTextColor, 0, gText_MoveCloserToLinkPartner);
    PutWindowTilemap(0);
    PutWindowTilemap(2);
...
static void ErrorMsg_CheckConnections(void)
{
    ...
    FillWindowPixelBuffer(2, PIXEL_FILL(0));
    AddTextPrinterParameterized3(1, FONT_NORMAL_COPY_2, RTL_ANCHOR_WINDOW(1) - 2, 0, sLinkErrorTextColor, 0, gText_CommErrorCheckConnections);
    PutWindowTilemap(1);
    PutWindowTilemap(2);
...
static void CB2_PrintErrorMessage(void)
{
    ...
    case 130:
        if (gWirelessCommType == 2)
            AddTextPrinterParameterized3(0, FONT_NORMAL_COPY_2, RTL_ANCHOR_WINDOW(0) - 2, 20, sLinkErrorTextColor, 0, gText_ABtnTitleScreen);
        else if (gWirelessCommType == 1)
            AddTextPrinterParameterized3(0, FONT_NORMAL_COPY_2, RTL_ANCHOR_WINDOW(0) - 2, 20, sLinkErrorTextColor, 0, gText_ABtnRegistrationCounter);
        break;
    }
    if (gMain.state == 160)
    {
