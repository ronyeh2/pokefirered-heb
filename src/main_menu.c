...
static void Task_PrintMainMenuText(u8 taskId)
{
    ...
    default:
        ...
        AddTextPrinterParameterized3(MAIN_MENU_WINDOW_NEWGAME_ONLY, FONT_NORMAL, 150, 2, sTextColor1, -1, gText_NewGame);
    ...
    case MAIN_MENU_CONTINUE:
        ...
        AddTextPrinterParameterized3(MAIN_MENU_WINDOW_CONTINUE, FONT_NORMAL, 150, 2, sTextColor1, -1, gText_Continue);
        AddTextPrinterParameterized3(MAIN_MENU_WINDOW_NEWGAME, FONT_NORMAL, 150, 2, sTextColor1, -1, gText_NewGame);
        PrintContinueStats();
    ...
    case MAIN_MENU_MYSTERYGIFT:
        ...
        AddTextPrinterParameterized3(MAIN_MENU_WINDOW_MYSTERYGIFT, FONT_NORMAL, 150, 2, sTextColor1, -1, gText_MysteryGift);
        PrintContinueStats();
        MainMenu_DrawWindow(&sWindowTemplate[MAIN_MENU_WINDOW_CONTINUE]);
        MainMenu_DrawWindow(&sWindowTemplate[MAIN_MENU_WINDOW_NEWGAME]);
...
static void PrintMessageOnWindow4(const u8 *str)
{
    ...
    AddTextPrinterParameterized3(MAIN_MENU_WINDOW_ERROR, FONT_NORMAL, 150, 2, sTextColor1, 2, str);
...
static void PrintPlayerName(void)
{
    ...
    AddTextPrinterParameterized3(MAIN_MENU_WINDOW_CONTINUE, FONT_NORMAL, 150, 18, sTextColor2, -1, gText_Player);
    ptr = name;
...
static void PrintPlayTime(void)
{
    ...
    AddTextPrinterParameterized3(MAIN_MENU_WINDOW_CONTINUE, FONT_NORMAL, 150, 34, sTextColor2, -1, gText_Time);
...
static void PrintDexCount(void)
{
    ...
    if (FlagGet(FLAG_SYS_POKEDEX_GET) == TRUE)
    {
        ...
        AddTextPrinterParameterized3(MAIN_MENU_WINDOW_CONTINUE, FONT_NORMAL, 150, 50, sTextColor2, -1, gText_Pokedex);
...
static void PrintBadgeCount(void)
{
    ...
    AddTextPrinterParameterized3(MAIN_MENU_WINDOW_CONTINUE, FONT_NORMAL, 150, 66, sTextColor2, -1, gText_Badges);
